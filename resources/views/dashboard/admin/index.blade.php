            ...
            <div class="relative overflow-x-auto">
                <table class="p-4 md:p-0 w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class=" text-xs text-gray-700 uppercase bg-gray-50 text-center ">
                        <tr>
                            <th scope="col" class="px-1 py-2 md:px-6 md:py-4">No.</th>
                            <th scope="col" class="px-1 py-2 md:px-6 md:py-4">Title</th>
                            <th scope="col" class="px-1 py-2 md:px-6 md:py-4 hidden md:table-cell">
                                Category</th>
                            <th scope="col" class="px-1 py-2 md:px-6 md:py-4">Author</th>
                            <th scope="col" class="px-1 py-2 md:px-6 md:py-4 hidden md:table-cell">
                                Image
                            </th>
                            <th scope="col" class="px-1 py-2 md:px-6 md:py-4 hidden md:table-cell">
                            ...
                            <th scope="col" class="px-1 py-2 md:px-6 md:py-4">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                    <tbody>
                        ...
                        <tr class="text-center bg-white border-b text-gray-900 cursor-pointer">
                            ...
                            <td
                                class="text-center px-2 py-2 md:px-6 md:py-4 flex flex-col gap-y-2 xl:flex-row xl:gap-x-2 xl:gap-y-0 ">
